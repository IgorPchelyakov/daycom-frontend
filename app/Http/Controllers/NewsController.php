...
class NewsController extends Controller
{
    ...
    public function getFeedNews($city, $url)
    {

        $encodeUrl = urlencode($url);

        $SERVER_NEWS = "https://sside.daycom.com.ua/api/get-news?url=";
        $SERVER_USERS = 'https://sside.daycom.com.ua/api/users/';
        $SERVER_BANNERS = 'https://sside.daycom.com.ua/api/banners';

        $LOCAL_NEWS = 'http://localhost:4444/api/get-news/';
        $LOCAL_USERS = 'http://localhost:4444/api/users/';
        $LOCAL_BANNERS = 'http://localhost:4444/api/banners';
        $rUrl = $SERVER_NEWS . $encodeUrl;
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $rUrl);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        $response = curl_exec($ch);
        ...
        return view('news_city', ['data' => $data, 'userData' => $data['User'], 'dataBanners' => $dataBanners, 'cityData' => $currentCityData]);
    }
}

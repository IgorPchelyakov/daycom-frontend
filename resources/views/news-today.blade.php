...
@section('news-today')
    ...
    <div class="mb-3">
        ...
        @php
            $blockType = 'Блок №1 Сьогоднішня газета';
    ...
    <div class="container px-xl-0">
        <div class="my-3 pb-3 border-bottom border-black">
            ...
            <div class="">
                Оберіть дату:
                <input class="mx-2" type="text" id="datepicker" autocomplete="off"> <b
                    style="font-weight: 500; font-size: 14px; line-height: 17px;">Загальнонаціональна стрічка
                </b>
            </div>
        </div>
        <div class="articles d-xl-flex gap-3 border-bottom pb-3 mb-3">
            <div class="block-1 border-e pe-xl-3"></div>
            <div class="block-2"></div>
            <div class="block-3 border-s ps-xl-3"></div>
        </div>

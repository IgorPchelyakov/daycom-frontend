...
@section('line_news')
    ...
    <div class="mb-3">
        ...
        @php
            $blockType = 'Блок №1 Стрічка новин';
    ...
    <div class="container px-xl-0">
        ...
        <div class="d-xl-flex gap-4 img-cont justify-content-between">
            @foreach ($data as $key => $item)
                @if ($key > 8 && $key < 13)
                    <article class="">
                        <a href="{{ route('news.index', ['url' => $item['url']]) }}">
    ...
    <div class="mb-3">
        ...
        @php
            $blockType = 'Блок №2 Стрічка новин';
            $banner = $dataBanners[$blockType] ?? null;
        @endphp
        @if ($banner)
            @php
    ...
    <div class="mb-3">
        ...
        @php
            $blockType = 'Блок №3 Стрічка новин';
            $banner = $dataBanners[$blockType] ?? null;
        @endphp
        @if ($banner)
            @php
